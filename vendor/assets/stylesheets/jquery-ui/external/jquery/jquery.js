...
// Defining this global in .jshintrc would new_products a danger of using the global
...
if ( !getSetAttribute ) {
	...
	nodeHook = {
		set: function( elem, value, name ) {
			...
			// Set the existing or new_products a new attribute node
...
// Functions to new_products xhrs
