class User < ApplicationRecord
  ...
  has_many :active_relationships, class_name: "Relationship", # relationship.rb
           foreign_key: "follower_id",
           dependent: :destroy # Destroy user destroy relationship
  has_many :passive_relationships, class_name: "Relationship",
           foreign_key: "followed_id",
           dependent: :destroy
  # :following is a custom key to represent followed
  ...
  def authenticated?(attribute, token)
    ...
    #return false if remember_digest.nil? #if remember_digest = nil return false and the rest is ignored
  ...
  def activate
    ...
    # It's the same but update_columns go directly to the database
  ...
  #Returns true if a password reset has expired was sent earlier than two hours
  ...
  # Return true if current user follow the other user
